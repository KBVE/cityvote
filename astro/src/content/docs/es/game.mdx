...
title: |
  Juega a CityVote
description: |
  Experimenta CityVote en tu navegador con Unity WebGL
template: splash
hero:
...
## Juega a CityVote en tu Navegador

Prepárate para enfrentar el desafío definitivo de supervivencia. CityVote se ejecuta directamente en tu navegador usando tecnología Unity WebGL - no se requiere instalación.
