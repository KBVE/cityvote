...
# Paths
CARDS_DIR = '../cat/nodes/cards/playing'
OUTPUT_PATH = '../cat/nodes/cards/playing/card_atlas.png'
...
def validate_card_dimensions():
    ...
    # Check custom cards
    print()
    print("Checking custom cards (2 cards)...")
    ...
    print()
    if all_valid:
        print("✅ All 54 cards validated successfully!")
        print()
        return True
    else:
...
def create_card_atlas():
    ...
    print("  Row 4: Custom     (vikings-53, dino-54)")
    print()
